    ...
    return (
        <footer>
            ...
            <div className="footer-bottom">
                ...
                <div className="footer-bottom_right"></div>
            </div>
        </footer>
    );
}
